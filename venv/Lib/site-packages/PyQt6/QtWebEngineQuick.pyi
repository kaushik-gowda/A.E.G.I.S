...
class QQuickWebEngineProfile(QtCore.QObject):
    ...
    class PersistentCookiesPolicy(enum.Enum):
        ...
        OnlyPersistentCookies = ... # type: QQuickWebEngineProfile.PersistentCookiesPolicy
    ...
    @typing.overload
    def __init__(self, storageName: str|None, parent: QtCore.QObject|None = ...) -> None: ...

    def extensionManager(self) -> QtWebEngineCore.QWebEngineExtensionManager|None: ...
    ...
    def clientCertificateStore(self) -> QtWebEngineCore.QWebEngineClientCertificateStore|None: ...
    ...
    def removeUrlSchemeHandler(self, a0: QtWebEngineCore.QWebEngineUrlSchemeHandler|None) -> None: ...
    def removeUrlScheme(self, scheme: QtCore.QByteArray|bytes|bytearray|memoryview) -> None: ...
    def installUrlSchemeHandler(self, scheme: QtCore.QByteArray|bytes|bytearray|memoryview, a1: QtWebEngineCore.QWebEngineUrlSchemeHandler|None) -> None: ...
    def urlSchemeHandler(self, a0: QtCore.QByteArray|bytes|bytearray|memoryview) -> QtWebEngineCore.QWebEngineUrlSchemeHandler|None: ...
    def setUrlRequestInterceptor(self, interceptor: QtWebEngineCore.QWebEngineUrlRequestInterceptor|None) -> None: ...
